  ...
  return renderToStaticMarkup(
    createElement(
      ...
      createElement(RouteEditor, {
        ...
        canMoveUp: false,
        canMoveDown: false,
        catchAllOutOfOrder: false,
        onChange: () => undefined,
        onMoveUp: () => undefined,
        onMoveDown: () => undefined,
        onMoveCatchAllToEnd: () => undefined,
        onRemove: () => undefined,
      })
    )
  )
...
describe('advanced custom route editor UI', () => {
  test('renders the grouped route row, native visual, responsive actions, and aligned auth row', () => {
