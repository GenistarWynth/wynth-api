...
} from '../lib/channel-status-filter'
...
const CHANNELS_COLUMN_FILTERS = [
  {
    columnId: 'status',
    searchKey: 'status',
    type: 'array' as const,
    deserialize: resolveChannelStatusFilter,
  },
  { columnId: 'type', searchKey: 'type', type: 'array' as const },
  { columnId: 'group', searchKey: 'group', type: 'array' as const },
...
export function ChannelsTable() {
  ...
  const {
    ...
    columnFilters: CHANNELS_COLUMN_FILTERS,
  })
  ...
  const handleColumnFiltersChange: OnChangeFn<ColumnFiltersState> = (
    ...
    onColumnFiltersChange((previous) => {
      ...
      persistChannelStatusFilter(
        next.find((filter) => filter.id === 'status')?.value
      )
      return next
    })
  }
