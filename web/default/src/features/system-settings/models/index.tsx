...
const defaultModelSettings: ModelSettings = {
  ...
  'monitor_setting.dead_channel_recovery_min_minutes': 15,
  'monitor_setting.dead_channel_recovery_max_minutes': 120,
  'monitor_setting.dead_channel_recovery_max_per_tick': 5,
