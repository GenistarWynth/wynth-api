...
var channelReadOnlyFields = map[string]struct{}{
	...
	"used_quota":           {},
	// Wynth server-managed metadata fields (not user-writable):
	"updated_time":   {},
	"last_sync_time": {}, // upstream-source generated channel sync timestamp
	"monitor_info":   {}, // channel monitor status snapshot
}
