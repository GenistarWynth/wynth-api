...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		upstreamSourceRoute.Use(middleware.AdminAuth())
		{
			...
			upstreamSourceRoute.DELETE("/:id/session", controller.ClearUpstreamSourceSession)
			upstreamSourceRoute.PUT("/:id/monitor", controller.UpdateUpstreamSourceMonitor)
			...
			upstreamSourceRoute.GET("/:id/mappings/:mapping_id/billing_probe", controller.GetUpstreamSourceBillingProbe)
			upstreamSourceRoute.PUT("/:id/mappings/:mapping_id/billing_probe", controller.UpdateUpstreamSourceBillingProbe)
			upstreamSourceRoute.POST("/:id/mappings/:mapping_id/billing_probe/run", controller.RunUpstreamSourceBillingProbe)
			upstreamSourceRoute.GET("/:id/scans", controller.ListUpstreamSourceScans)
			upstreamSourceRoute.GET("/:id/monitor/runs", controller.ListUpstreamSourceMonitorRuns)
			upstreamSourceRoute.GET("/:id/monitor/snapshots", controller.GetUpstreamSourceMonitorSnapshots)
			upstreamSourceRoute.GET("/:id/monitor/outcomes", controller.ListUpstreamSourceCapabilityOutcomes)
			upstreamSourceRoute.GET("/:id/announcements", controller.ListUpstreamSourceAnnouncements)
			upstreamSourceRoute.GET("/:id/changes", controller.ListUpstreamSourceGroupChanges)
			upstreamSourceRoute.GET("/:id/notification_subscriptions", controller.ListUpstreamSourceNotificationSubscriptions)
			upstreamSourceRoute.POST("/:id/notification_subscriptions", controller.CreateUpstreamSourceNotificationSubscription)
			upstreamSourceRoute.PUT("/:id/notification_subscriptions/:subscription_id", controller.UpdateUpstreamSourceNotificationSubscription)
			upstreamSourceRoute.DELETE("/:id/notification_subscriptions/:subscription_id", controller.DeleteUpstreamSourceNotificationSubscription)
			upstreamSourceRoute.GET("/:id/notification_deliveries", controller.ListUpstreamSourceNotificationDeliveries)
		...
		// Channel routes were extracted upstream into registerChannelRoutes (a
		// permission-gated table) + registerAuthzRoutes. Wynth's channel additions
		// live in that table now (see router/channel-router.go), e.g. /:id/monitor.
