...
func TestChannelMonitorSettingsRouteUsesWritePermission(t *testing.T) {
	assertChannelRoutePermission(t, http.MethodPut, "/:id/monitor", authz.ChannelWrite, controller.UpdateChannelMonitorSettings)
}
