...
type ChatToResponsesStreamState struct {
	...
	toolRestore       *convmeta.ResponsesToolRestoreMetadata
}
...
func NewChatToResponsesStreamState(id string, model string, metadata ...*convmeta.ResponsesToolRestoreMetadata) *ChatToResponsesStreamState {
