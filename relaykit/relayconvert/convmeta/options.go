...
type Options struct {
	...
	// ResponsesToolRestore reverses namespace/tool-search flattening performed
	// when a Responses request is sent to a chat-compatible upstream.
	ResponsesToolRestore *ResponsesToolRestoreMetadata
